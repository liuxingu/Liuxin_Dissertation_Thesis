...
Key building blocks for this consist electro optical modulators, high responsivity photodetectors, compact on-chip light sources(or external input coupling), low-loss waveguides/couplers, and driver electronics\cite{Miller2009-hw}.
Among them, materials such as III–V, LiNbO$_3$, 2D semiconductors provide efficient gain, fast modulation and strong electro-optic effects\cite{Sun2016-gg}.
...
One key goal is achieving photon blockade, in which the presence of a single photon shifts the system energy to prevent the entry of a second\cite{Imamoglu1997-pb}. 
This enables single-photon switches, quantum logic gates, and generation of nonclassical light source, all essential components for scalable quantum photonic circuits\cite{UnknownUnknown-cd}. 
...
Their tightly bound excitons exhibit large oscillator strengths and support strong exciton–exciton and exciton–carrier interactions, giving rise to large Kerr-like optical nonlinearities\cite{Wang2018-qm,}. 

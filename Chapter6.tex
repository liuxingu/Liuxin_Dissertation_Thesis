...
Early approaches used individual quantum emitters such as atoms, molecules, or defects, where a single photon can substantially alter absorption or reflectance~\cite{}{ref5,ref6,ref7,ref8}. 
While these systems demonstrate strong nonlinearities, their practical use is limited by the challenge of deterministically coupling photons to isolated emitters~\cite{ref9,ref10}.  

Excitons in semiconductors offer a collective platform, with large oscillator strengths that enable strong light--matter coupling.
However, because excitons are charge neutral, their mutual interactions are relatively weak, producing nonlinearities on the order of only a few $\mu$eV$\cdot\mu$m$^2$ across both TMDs and quantum wells~\cite{ref11,ref12,ref13}.  

Embedding excitons in optical cavities forms exciton--polaritons, hybrid light--matter quasiparticles that inherit both strong coupling and nonlinear response~\cite{ref19,ref20,ref21}. 
Compared with bare excitons, polaritons often show enhanced nonlinearities due to modified linewidths and collective light--matter interactions. 
Nonlinear shifts can also arise from phase-space filling, where exciton saturation reduces the available oscillator strength~\cite{ref22,ref23,ref24}.  

TMD monolayers provide an especially attractive platform due to their large binding energies (200--500 meV) and strong oscillator strengths, enabling robust polariton formation even at room temperature~\cite{ref27}. Recent studies have reported enhanced nonlinearities in higher-order exciton states, biexcitons, and trions~\cite{ref24,ref28,ref29}, though these gains can come at the cost of weaker light coupling. Interlayer excitons, with their strong dipole--dipole repulsion, and moiré-confined excitons further offer routes to boost polariton interactions by an order of magnitude or more~\cite{ref15,ref30,ref31,ref32,ref33}.  

These advances suggest that exciton--polaritons in 2D materials are a promising pathway toward the \textit{quantum nonlinear optics regime}, where the interaction strength exceeds the linewidth. In this limit, a single polariton can block the transmission of others, giving rise to photon blockade and enabling nonclassical light sources~\cite{ref36,ref37,ref38,ref39,ref40,ref41}.  

...
Embedding TMDs or other 2D materials with a 1D microcavity has already been demonstrated~\cite{Paik2024-ip}. 
...
This square-root scaling is well established in strongly coupled systems such as GaAs and CdTe multiple–quantum-well microcavities\cite{Skolnick1998-pj},even for multilayer TMD\cite{Zhao2023-ax},  
...
Experimentally, we indeed observe only a broadening of the dip feature with increasing gate voltage, which can be attributed to linewidth broadening of the polaron species arising from exciton–carrier scattering\cite{Sidler2017-ff,many }.

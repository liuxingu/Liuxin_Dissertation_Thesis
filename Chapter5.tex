...
The redshift of charged excitons with increasing doping can be explained in terms of attractive Fermi polarons~\cite{ref23}, or by an increase in the exciton--trion energy splitting with increasing Fermi energy~\cite{Mak2013-oy}. 
...
As a result, electrostatically doped holes at the $\Gamma$ point could be efficiently scattered into the $K$ valley by excitons such as X$_A$ and X$_I$, via Coulombic and exchange interactions~\cite{Courtade2017-cf,Fey2020-yf} (Figure~\ref{fig.5.11}b). 

...
Transition metal dichalcogenides(TMD) semicondcutor have the general chemical formula of MX$_2$, where $M$ refers to the transition metal atom($Mo,W$) and $X$ is the chalcogen atom($S$,$Se$,$Te$).
...
Figures are adpated from\cite{Deng2010-ul}.}

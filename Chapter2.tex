...
$d_{z^2}$ state to nearby orbitals that carry finite angular momentum ($m_l = \pm 1$), most importantly the transition-metal $d_{xz}/d_{yz}$ and chalcogen $p_x/p_y$ states\cite{Liu2013-jh,Kosmider}. 
\cite{Liu2013-jh,Kosmider2013-pf}
